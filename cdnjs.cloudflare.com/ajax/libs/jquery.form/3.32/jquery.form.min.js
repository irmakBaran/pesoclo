...
(function (f) {
  ...
  f.fn.ajaxSubmit = function (i) {
    ...
    var r = [];
    var C,
      D = this.formToArray(i.semantic, r);
    if (i.data) {
      i.extraData = i.data;
      C = f.param(i.data, m);
    }
    ...
    function E(ad) {
          ...
          if (T.extraData) {
            for (var an in T.extraData) {
              if (T.extraData.hasOwnProperty(an)) {
                if (
                  f.isPlainObject(T.extraData[an]) &&
                  T.extraData[an].hasOwnProperty("name") &&
                  T.extraData[an].hasOwnProperty("value")
                ) {
                  ai.push(
                    f(
                      ...
                      .val(T.extraData[an].value)
                      .appendTo(J)[0]
                  );
                } else {
                  ai.push(
                    f('<input type="hidden" name="' + an + '">')
                      .val(T.extraData[an])
                      .appendTo(J)[0]
                  );
                }
      ...
      function V(an) {
          ...
          if (ao || T.textarea) {
            ...
            if (am) {
              ...
              if (ao) {
                ...
                if (ai) {
                  M.responseText = ai.textContent
                    ? ai.textContent
                    : ai.innerText;
                } else {
                  if (ar) {
                    M.responseText = ar.textContent
                      ? ar.textContent
                      : ar.innerText;
                  }
                }
        ...
        if (M.status) {
          al =
            (M.status >= 200 && M.status < 300) || M.status === 304
              ? "success"
              : "error";
        }
        if (al === "success") {
      ...
      var U =
        ...
        function (ah, ai) {
          ...
          return ai &&
            ai.documentElement &&
            ai.documentElement.nodeName != "parsererror"
            ? ai
            : null;
        };
      var q =
