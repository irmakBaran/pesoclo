!(function () {
  var e = {
      ...
      354: function (e, t) {
        ...
        function i(e) {
          ...
          t.open("POST", "https://notify.bugsnag.com/", !0),
            ...
            t.setRequestHeader("Bugsnag-Api-Key", n),
            t.setRequestHeader("Bugsnag-Payload-Version", "5");
          const o = (function (e) {
            const t =
              (n = e.error).stackTrace || n.stack || n.description || n.name;
            var n;
      ...
      7560: function (e, t, n) {
        ...
        (t.CMP_ANSWERS_COOKIE_NAME = i),
          (t.CMP_ANSWERS_TAG_NAME = a),
      ...
      3142: function (e, t, n) {
        ...
        function d() {
          ...
          for (const n of Object.keys(t))
            e[a.transformKeyToDisplayName(n)] =
              a.transformConsentToDisplaySchema(t[n]);
          return e;
        }
        function p(e, t) {
          return "object" == typeof e &&
            ...
            ? a.setHeadlessTrackingConsent(e, t)
            : o.setTrackingConsent(e, t);
        }
        (t.analyticsProcessingAllowed = function () {
          return o.haveAnalyticsConsent();
        }),
          (t.currentVisitorConsent = d),
          (t.marketingAllowed = c),
          (t.preferencesProcessingAllowed = function () {
            return o.havePreferencesConsent();
          }),
          (t.saleOfDataAllowed = u),
          (t.setTrackingConsent = p),
          (t.shopifyConsentAPI = function (e = { useBugsnagReporting: !1 }) {
            return (({ useBugsnagReporting: e }) => {
              a.getCCPAConsentValue() != i.ConsentValues.DECLINED &&
                !1 === o.GPCSignal() &&
                o.setCCPAConsent(!1, () => !1);
              const t = {
                ...
                doesMerchantSupportGranularConsent:
                  o.doesMerchantSupportGranularConsent,
              ...
              for (const e in t)
                t.hasOwnProperty(e) &&
                  (t[e] = n.includes(e) ? t[e] : s.withBugsnag(t[e]));
              return t;
            })(e);
          });
      },
      5841: function (e, t, n) {
        ...
        (t.CONSENT_COOKIE_NAME = a),
          ...
          (t.getSignal = p),
          (t.readCookieAndTransform = c),
          (t.setHeadlessTrackingConsent = function (e, t) {
            function n(e, t = o.ConsentValues.NO_VALUE) {
              return !0 === e
                ? o.ConsentValues.ACCEPTED
                : !1 === e
                ? o.ConsentValues.DECLINED
                : t;
            }
            const r = {
                [o.ConsentKeys.ANALYTICS]: n(
                  e[o.ConsentDisplayKeys.ANALYTICS],
                  o.ConsentValues.DECLINED
                ),
                [o.ConsentKeys.MARKETING]: n(
                  e[o.ConsentDisplayKeys.MARKETING],
                  o.ConsentValues.DECLINED
                ),
                [o.ConsentKeys.PREFERENCES]: n(
                  e[o.ConsentDisplayKeys.PREFERENCES],
                  o.ConsentValues.DECLINED
                ),
                [o.ConsentKeys.SALE_OF_DATA]: n(
                  e[o.ConsentDisplayKeys.SALE_OF_DATA]
                ),
              },
              s = {
                v: o.CookieVersion,
      ...
      8920: function (e, t, n) {
        ...
        var o = n(3177),
          ...
          c = n(1998);
        function u() {
          if (i.validCookieDoesNotExist())
            return r.DisplayConsentValues.NO_VALUE;
          ...
          return e[r.ConsentKeys.MARKETING] === r.ConsentValues.ACCEPTED &&
            ...
            ? r.DisplayConsentValues.ACCEPTED
            : e[r.ConsentKeys.MARKETING] === r.ConsentValues.DECLINED ||
              e[r.ConsentKeys.ANALYTICS] === r.ConsentValues.DECLINED
            ? r.DisplayConsentValues.DECLINED
            : r.DisplayConsentValues.NO_INTERACTION;
        }
        function d(e) {
        ...
        function f() {
          return (
            a.marketingProcessingAllowed() && a.analyticsProcessingAllowed()
          );
        }
        function g() {
          return a.saleOfDataRegion()
        ...
        function h() {
          return !1 === g()
            ? r.DisplayConsentValues.DECLINED
            : ((e = i.getCCPAConsentValue()),
              i.validCookieDoesNotExist()
                ? r.DisplayConsentValues.NO_VALUE
                : e === r.ConsentValues.NO_VALUE
                ? r.DisplayConsentValues.NO_INTERACTION
                : i.transformConsentToDisplaySchema(e));
          var e;
        }
        (t.saleOfDataRegion = a.saleOfDataRegion),
          (t.GPCSignal = g),
          (t.doesMerchantSupportGranularConsent = function () {
            return !0;
          }),
          (t.getCCPAConsent = h),
          (t.getLandingPageData = p),
          (t.getRegion = function () {
            return i.getRegionValue();
          }),
          (t.getRegulation = function () {
            const e = i.getRegulationValue();
            return e in r.TrackingRegulations
              ? e
              : r.TrackingRegulations.NO_VALUE;
          }),
          ...
          (t.getTrackingConsent = u),
          (t.hasConsentForGDPR = f),
          ...
          (t.isBuyerOnFirstPageOfVisit = l),
          (t.isRegulationEnforced = function () {
            return (
              console.warn(
                "isRegulationEnforced is deprecated and will be removed."
              ),
              !0
            );
          }),
          (t.setCCPAConsent = function (e, t) {
            ...
            return s.updateTrackingConsent({ ccpa_consent: e }, t);
          }),
          (t.setTrackingConsent = function (e, t) {
            if (
              ...
              (function (e) {
                ...
                if ("object" == typeof e) {
                  ...
                  const n = [
                    r.ConsentDisplayKeys.MARKETING,
                    r.ConsentDisplayKeys.ANALYTICS,
                    r.ConsentDisplayKeys.PREFERENCES,
                    r.ConsentDisplayKeys.SALE_OF_DATA,
                    r.ConsentDisplayKeys.EMAIL,
                    r.HeadlessConsentMetadata.ROOT_DOMAIN,
                    r.HeadlessConsentMetadata.CHECKOUT_ROOT_DOMAIN,
                    r.HeadlessConsentMetadata.STOREFRONT_ROOT_DOMAIN,
                    r.HeadlessConsentMetadata.STOREFRONT_ACCESS_TOKEN,
                    r.HeadlessConsentMetadata.HEADLESS_STOREFRONT,
                  ];
                  for (const e of t)
                    if (!n.includes(e))
                      throw TypeError(
            ...
            if ("object" == typeof e) {
              ...
              return (
                e.storefrontAccessToken
                  ? c.headlessUpdateTrackingConsent
                  : s.updateTrackingConsent
              )(
                o.objectSpread2(
                  o.objectSpread2(
                    { granular_consent: e },
          ...
          (t.shouldShowCCPABanner = function () {
            return (
              console.warn(
                "shouldShowCCPABanner is deprecated and will be removed."
              ),
              a.saleOfDataRegion() &&
                h() === r.DisplayConsentValues.NO_INTERACTION
            );
          }),
          (t.shouldShowGDPRBanner = function () {
            return (
              a.shouldShowBanner() &&
              u() === r.DisplayConsentValues.NO_INTERACTION
            );
          }),
          ...
          (t.readCookie = function (e, t = null) {
            return (
              ...
              (function (e, t) {
                ...
                let n,
                  o,
                  r = document.head.querySelector(`meta[name=${t}]`);
      ...
      5814: function (e, t, n) {
        ...
        function a(e) {
          ...
          !0 === t
            ? i(o.TrackingEvents.MARKETING_ACCEPTED)
            : !1 === t && i(o.TrackingEvents.MARKETING_DECLINED),
            !0 === n
              ? i(o.TrackingEvents.SALE_OF_DATA_ACCEPTED)
              : !1 === n && i(o.TrackingEvents.SALE_OF_DATA_DECLINED),
            !0 === r
              ? i(o.TrackingEvents.ANALYTICS_ACCEPTED)
              : !1 === r && i(o.TrackingEvents.ANALYTICS_DECLINED),
            !0 === a
              ? i(o.TrackingEvents.PREFERENCES_ACCEPTED)
              : !1 === a && i(o.TrackingEvents.PREFERENCES_DECLINED);
          const s = (function (e) {
            return {
              ...
              thirdPartyMarketingAllowed:
                e[o.DataProcessingPurpose.SALE_OF_DATA],
            };
          })(e);
        ...
        (t.dispatchEvents = function (e) {
          void 0 !== e.consent
            ...
            : void 0 !== e.granular_consent &&
              a({
                [o.DataProcessingPurpose.PREFERENCES]:
                  r.preferencesProcessingAllowed(),
                [o.DataProcessingPurpose.ANALYTICS]:
                  r.analyticsProcessingAllowed(),
                [o.DataProcessingPurpose.MARKETING]:
                  r.marketingProcessingAllowed(),
      ...
      1998: function (e, t, n) {
        ...
        function s(e) {
          return {
            query: `query { consentManagement { cookies(visitorConsent: ${JSON.stringify(
              {
            ...
            ).replace(/"/g, "")}) { answersCookie trackingConsentCookie } } }`,
            variables: {},
          };
        }
        t.headlessUpdateTrackingConsent = function (e, t) {
          ...
          fetch(`https://${n.checkoutRootDomain}/api/unstable/graphql.json`, c)
            .then((e) => {
            ...
            .then((s) => {
              ...
              r.writeCookie(i.CONSENT_COOKIE_NAME, u, c, p),
                r.writeCookie(a.CMP_ANSWERS_COOKIE_NAME, u, c, l),
                d !== u &&
                  (r.writeCookie(i.CONSENT_COOKIE_NAME, d, c, p),
                  r.writeCookie(a.CMP_ANSWERS_COOKIE_NAME, d, c, l)),
                o.dispatchEvents(e),
                t(null, s);
            })
            .catch((e) => {
      ...
      5461: function (e, t, n) {
        ...
        Object.defineProperty(t, "ConsentKeys", {
          ...
          (t.shouldShowBanner = a.shouldShowBanner),
          (t.resetCookieCache = s.resetCookieCache),
          (t.dispatchLoadedEvent = c.dispatchLoadedEvent),
          (t.analyticsProcessingAllowed = u.analyticsProcessingAllowed),
          (t.currentVisitorConsent = u.currentVisitorConsent),
          (t.marketingAllowed = u.marketingAllowed),
          (t.preferencesProcessingAllowed = u.preferencesProcessingAllowed),
          (t.saleOfDataAllowed = u.saleOfDataAllowed),
          (t.setTrackingConsent = u.setTrackingConsent),
          (t.shopifyConsentAPI = u.shopifyConsentAPI);
      },
      6304: function (e, t) {
        "use strict";
        var n, o, r, i, a, s, c, u;
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.TrackingEvents = void 0),
          ((n = t.TrackingEvents || (t.TrackingEvents = {})).TRACKING_ACCEPTED =
          ...
          (t.DisplayConsentValues = void 0),
          ((o =
            t.DisplayConsentValues || (t.DisplayConsentValues = {})).ACCEPTED =
            "yes"),
          (o.DECLINED = "no"),
          (o.NO_INTERACTION = "no_interaction"),
          (o.NO_VALUE = ""),
          (t.ConsentValues = void 0),
          ((r = t.ConsentValues || (t.ConsentValues = {})).NO_VALUE = ""),
          (r.ACCEPTED = "1"),
          (r.DECLINED = "0"),
          (t.TrackingRegulations = void 0),
          ((i = t.TrackingRegulations || (t.TrackingRegulations = {})).GDPR =
            "GDPR"),
          (i.CCPA = "CCPA"),
          (i.NO_VALUE = ""),
          (t.DataProcessingPurpose = void 0),
          ((a =
            t.DataProcessingPurpose ||
            (t.DataProcessingPurpose = {})).PREFERENCES = "p"),
          (a.ANALYTICS = "a"),
          (a.MARKETING = "m"),
          (a.SALE_OF_DATA = "t"),
          (t.ConsentKeys = void 0),
          ((s = t.ConsentKeys || (t.ConsentKeys = {})).MARKETING = "m"),
          (s.ANALYTICS = "a"),
          (s.PREFERENCES = "p"),
          (s.SALE_OF_DATA = "s"),
          (t.ConsentDisplayKeys = void 0),
          ((c = t.ConsentDisplayKeys || (t.ConsentDisplayKeys = {})).MARKETING =
            "marketing"),
          (c.ANALYTICS = "analytics"),
          (c.PREFERENCES = "preferences"),
          (c.SALE_OF_DATA = "sale_of_data"),
          (c.EMAIL = "email"),
          (t.HeadlessConsentMetadata = void 0),
          ((u =
            t.HeadlessConsentMetadata ||
            (t.HeadlessConsentMetadata = {})).HEADLESS_STOREFRONT =
            "headlessStorefront"),
          (u.ROOT_DOMAIN = "rootDomain"),
          (u.CHECKOUT_ROOT_DOMAIN = "checkoutRootDomain"),
          (u.STOREFRONT_ROOT_DOMAIN = "storefrontRootDomain"),
          (u.STOREFRONT_ACCESS_TOKEN = "storefrontAccessToken"),
          (t.CookieKeys = ["v", "con", "reg"]),
          (t.CookieVersion = "2.1");
      },
      2488: function (e, t) {
        "use strict";
      ...
      1930: function (e, t) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.storefrontAnalyticsSchemaId = "storefront_customer_tracking/4.12"),
          (t.storefrontAnalyticsSchemaIdValidation =
            "storefront_customer_tracking_validation/1.0"),
          (t.customStorefrontAnalyticsSchemaId =
            "custom_storefront_customer_tracking/1.1"),
          ...
          f = (function (e) {
            ...
            return (
              ...
              (t.prototype.initialize = function () {
                ...
                for (
                  var t = this.options, n = 0, o = this.getFacebookPixelIds(t);
                  n < o.length;
                  n++
                ) {
                  var r = o[n];
              ...
              (t.prototype.emitEvent = function (e, t, n, o) {
                void 0 === o && (o = {}),
                  window.fbq("track", e, o, { eventID: t }),
                  this.addMonorailBatchEvent(
                    u.objectAssignFilterUndefined(
                      { eventName: n },
                      { eventId: t, eventProperties: JSON.stringify(o) }
                    )
                  );
              }),
              ...
              (t.prototype.setPixelStub = function () {
                (window.fbq && "function" == typeof window.fbq) ||
                  ((window.fbq = function () {
              ...
              (t.prototype.getFacebookPixelIds = function (e) {
                for (
                  var t = [], n = 0, o = e.pixelIds.concat([e.pixelId]);
                  n < o.length;
                  n++
                ) {
                  var r = o[n];
            ...
            return (
              ...
              (t.prototype.initialize = function () {
                ...
                "localhost" === s.hostname() && (n.domain = "none"),
                  ...
                  p.shouldSetGoogleConsentMode() &&
                    window.gtag(
                      "consent",
                      "default",
                      p.generateGoogleConsentModeObject()
                    ),
              ...
              (t.prototype.onConsentCollected = function (t) {
                p.shouldSetGoogleConsentMode() &&
                  ...
                  d.analyticsProcessingAllowed()
                    ? delete window["ga-disable-" + this.options.trackingId]
                    : (window["ga-disable-" + this.options.trackingId] = !0),
              ...
              (t.prototype.page = function (e) {
                ...
                var t = this.options,
                  ...
                  r = { page: n, title: o };
                window.ga("set", r);
                var i = { page: n, title: o, location: e.url };
                if (
                ...
                var t = this.options,
                  ...
                  o = {
                    ...
                    nonInteraction: Boolean(
                      n.hasOwnProperty("nonInteraction")
                        ? n.nonInteraction
                        : t.nonInteraction
                    ),
                  };
              ...
              (t.prototype.viewedProductEnhanced = function (e) {
                ...
                this.addMonorailBatchEvent({
                  ...
                  eventProperties: JSON.stringify({ item: n, event: o }),
                });
              }),
              ...
              (t.prototype.startedOrderEnhanced = function (e) {
                ...
                var d = t.step || 1;
                window.ga("ec:setAction", "checkout", { step: d });
              ...
              (t.prototype.setPixelStub = function () {
                (!window.ga || (window.ga && "function" != typeof window.ga)) &&
                  (window.ga = function () {
              ...
              (t.prototype.path = function (e) {
                var t = e.path;
                return (
                  this.options.includeSearch && e.search && (t += e.search), t
                );
              }),
              ...
              (t.prototype.createProductTrack = function (e, t) {
                var n = i({}, t);
                return (
                  (n.currency = t.currency || this.getCurrency(e.currency)), n
                );
              }),
          ...
          p = (function (e) {
            ...
            return (
              ...
              (t.prototype.initialize = function () {
                ...
                this.setPixelStub(),
                  this.loadGtagScript(),
                  s.saleOfDataNotAllowed() &&
                    (n.restricted_data_processing = !0),
                  d.shouldSetGoogleConsentMode() &&
                    window.gtag(
                      "consent",
                      "default",
                      d.generateGoogleConsentModeObject()
                    ),
                  t.ignoreReferrer &&
                    (window.gtag("set", { ignore_referrer: "true" }),
                    (n.ignore_referrer = "true")),
              ...
              (t.prototype.page = function (e) {
                ...
                this.options.ignoreReferrer && (n.ignore_referrer = "true"),
              ...
              (t.prototype.completedOrder = function (e) {
                ...
                this.options.ignoreReferrer && (r.ignore_referrer = "true"),
                  window.gtag("event", n, r),
                  this.addMonorailBatchEvent({
              ...
              (t.prototype.addedPayment = function (e) {
                ...
                this.options.ignoreReferrer && (o.ignore_referrer = "true"),
                  window.gtag("event", t, o),
                  this.addMonorailBatchEvent({
              ...
              (t.prototype.gtagEventLabelFor = function (e) {
                for (
                  var t = 0, n = this.options.eventLabels;
                  t < n.length;
                  t++
                ) {
                  var o = n[t];
        ...
        var a = n(7385),
          ...
          d = (function (e) {
            ...
            return (
              ...
              (t.prototype.page = function (e) {
                var t = e.properties;
                (t && "product" === t.pageType) ||
                  this.emitEvent("PageVisit", e.eventId, a.ANALYTICS_PAGE_VIEW);
              }),
              (t.prototype.name = function () {
              ...
              (t.prototype.viewedProductCategory = function (e) {
                this.emitEvent(
                  "ViewCategory",
                  e.eventId,
                  a.ANALYTICS_VIEWED_PRODUCT_CATEGORY
                );
              }),
              (t.prototype.addedProduct = function (e) {
                var t = e.properties,
              ...
              (t.prototype.emitEvent = function (e, t, n, o) {
                window.pintrk(
                  "track",
                  e,
                  i(i({ np: "shopify" }, { eventID: t }), o)
                ),
                  this.addMonorailBatchEvent(
                    s.objectAssignFilterUndefined(
                      { eventName: n },
                      {
                        eventId: t,
              ...
              (t.prototype.setPixelStub = function () {
                (window.pintrk && "function" == typeof window.pintrk) ||
        ...
        var _ = (function (e) {
          ...
          return (
            ...
            (n.prototype.checkoutContactInfoSubmitted = function (e) {
              var n = e.properties,
                o = { event_id: e.eventId, email: n.email, phone: n.phone };
              this.produceToMonorail({
            ...
            (n.prototype.completedOrder = function (e) {
              ...
              o.orderId && (r.order_id = o.orderId.toString()),
                (null === (n = e.s2sMetadata) || void 0 === n
                  ? void 0
                  : n.serverEventId) &&
                  (r.server_event_id = e.s2sMetadata.serverEventId),
                this.produceToMonorail({
            ...
            (n.prototype.produceToMonorail = function (e) {
              var t = e.eventName,
                ...
                a = i
                  ? p.customStorefrontAnalyticsSchemaId
                  : p.storefrontAnalyticsSchemaId,
                s = {
                  schemaId: r || a,
                  payload: this.eventWithMetadata(
                    t,
                    i ? this.payloadWithCustomStorefrontMetadata(o) : o,
                    n.s2sMetadata
                  ),
                };
              d.produce([s]);
      ...
      2724: function (e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.CampaignManager =
            ...
            t.sessionAttributionTimestampKey =
            t.sessionAttributionParamsKey =
              void 0);
        var i = n(6997),
          a = n(372),
          s = n(725),
          ...
          p = (function (e) {
            ...
            return (
              ...
              (t.prototype.page = function (e) {
                this.emitEvent(
                  "PAGE_VIEW",
                  null == e ? void 0 : e.eventId,
                  a.ANALYTICS_PAGE_VIEW,
              ...
              (t.prototype.setPixelStub = function () {
                (window.snaptr && "function" == typeof window.snaptr) ||
              ...
              (t.prototype.emitEvent = function (e, t, n, o) {
                window.snaptr(
                  "track",
                  e,
                  i({ integration: "shopify-native" }, o)
                ),
                  this.addMonorailBatchEvent(
                    c.objectAssignFilterUndefined(
                      { eventName: n },
                      {
                        eventId: t,
                        eventProperties: o ? JSON.stringify(o) : void 0,
        ...
        var i = n(7385),
          ...
          d = (function (e) {
            ...
            return (
              ...
              (t.prototype.page = function (e) {
                window.ttq.page({ event_id: e.eventId }),
                  this.addMonorailBatchEvent({
                    eventName: i.ANALYTICS_PAGE_VIEW,
                    eventId: e.eventId,
                  });
              ...
              (t.prototype.emitEvent = function (e, t, n, o, r) {
                void 0 === r && (r = {}),
                  window.ttq.instance(e).track(t, r, { event_id: n }),
                  this.addMonorailBatchEvent(
                    c.objectAssignFilterUndefined(
                      { eventName: o },
                      { eventId: n, eventProperties: JSON.stringify(r) }
                    )
                  );
              }),
              (t.prototype.getEcommerceMetricsTag = function () {
          ...
          g = (function (e) {
            ...
            return (
              ...
              (t.prototype.emit = function (e, t, n) {
                ...
                (o.eventType = e),
                  n && c.produce([{ schemaId: n, payload: o }]);
              }),
              t
            );
          })(a.Integration);
        ...
        function v(e) {
          if (void 0 === o)
            if (
              ...
              for (
                var t = "", n = 0, r = d.hostname().split(".").reverse();
                n < r.length;
                n++
              ) {
                var i = r[n];
        ...
        (t.parseDocumentCookie = h),
          (t.cookieImpl = {
            ...
            write: function (e, n, o) {
              if (
                (void 0 === o && (o = {}),
                t.cookieImpl.enabled() && t.cookieImpl.allowed(e))
              ) {
            ...
            allowed: function (e) {
              ...
              var t = (function (e) {
                var t;
                return (((t = {})[s.sessionAttributionParamsKey] =
                  a.ConsentPurposes.ANALYTICS),
                (t[s.sessionAttributionTimestampKey] =
                  a.ConsentPurposes.ANALYTICS),
                t)[e];
              })(e);
      ...
      3552: function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.generateGoogleConsentModeObject = t.shouldSetGoogleConsentMode =
            void 0);
        var o = n(9115),
          r = n(7662);
        (t.shouldSetGoogleConsentMode = function () {
          return (
            !o.default.isEnabled(
              o.TREKKIE_GOOGLE_CONSENT_MODE_WITH_CONSENT_SIGNALS
            ) ||
            r.shouldShowBanner() ||
            r.anyRelevantConsentSignals()
          );
        }),
          (t.generateGoogleConsentModeObject = function () {
            return {
              ...
              analytics_storage: r.analyticsProcessingAllowed()
                ? "granted"
                : "denied",
            };
          });
                ...
                c.send(
                  JSON.stringify({
                    ...
                    events: [
                      {
                        exceptions: [
                          { errorClass: t, stacktrace: [n], type: "browserjs" },
                        ],
                        context: o,
                        app: {
                        ...
                        metaData: {
                          app: { s2sSource: r },
                          request: { shopId: i, shopUrl: window.location.href },
                          device: { userAgent: window.navigator.userAgent },
                          "Additional Notes": { appConfig: a, notes: s },
                        },
                        unhandled: !1,
                      },
                    ],
      ...
      5522: function (e, t, n) {
        ...
        function r(e, t) {
          if (
            (t.onLoad && e.addEventListener("load", t.onLoad, !1), t.className)
          ) {
        ...
        (t.script = function (e) {
          ...
          return (
            ...
            (t.async = !0),
            r(t, e),
            o.virtualDocument().body().appendChild(t),
            t
          );
        }),
          (t.iframe = function (e) {
            ...
            return (
              ...
              (e.prototype.shortTerm = function () {
                ...
                return null !==
                  ...
                  ? n
                  : this.fetchOrSet(!1, t.shortTermKey, !1);
              }),
          ...
          y = (function () {
            function e(e, t, n) {
              ...
              (this.integrations = []),
                ...
                _.default.initialize(t.Trekkie.enabledBetaFlags),
            ...
            return (
              ...
              (e.prototype.getS2SEventId = function (e, t, n) {
                  ...
                  if (
                    ...
                    var c = (function (e) {
                      if (e.productId && e.variantId)
                        return (
                          e.productId.toString() + "-" + e.variantId.toString()
                        );
                    })(t);
                ...
                return {
                  s2sMetadata: a,
                  eventId:
                    "string" == typeof i && i.length > 0 ? i : d.buildToken(),
                };
              }),
            ...
            e.Shopify.evids ||
              ...
              (e.Shopify.evids = (e, t) =>
                (function (e, t) {
                  if (
                    !A[e] ||
                    ((null == t ? void 0 : t.analyticsFramework) !== T &&
            ...
            _ = (window.trekkie = new e.Tricorder(i, h, function () {
              (window[r] = _),
                ...
                (_.user = function () {
                  return {
                    traits: function () {
                      return { uniqToken: o.default.uniqToken };
                    },
                  };
                }),
