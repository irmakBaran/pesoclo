    ...
    !(function (t) {
      ...
      function s(t, e) {
        if ("undefined" == typeof XMLHttpRequest)
          return void e("XMLHttpRequest is not supported");
        ...
        (n.withCredentials = !0),
          ...
          (n.onreadystatechange = function () {
            4 === n.readyState &&
              (n.status >= 400
                ? e(null, n.statusText)
                : e(this.response, null));
          }),
          n.send();
      }
      function u(e, n, r) {
        if ("undefined" == typeof XMLHttpRequest)
          return void r("XMLHttpRequest is not supported");
        ...
        if (!n.recipientEmail) {
          const o = {
            ...
            sessionStorage: {
              trustBoxSettings: sessionStorage.getItem("trustBoxSettings"),
            },
            resolution: {
              width: Math.max(
        ...
        (i.withCredentials = !0),
          ...
          (i.onreadystatechange = function () {
            4 === i.readyState &&
              (i.status >= 400 ? r(i.statusText, i.status) : r(null, i.status));
          }),
          ...
          var p = (function () {
              function e(t) {
                ...
                if (n.getElementsByTagNameNS("*", "parsererror").length > 0) {
                  var r =
                    n.getElementsByTagName("parsererror")[0].textContent ||
                    "unknown";
                  ...
                  "floating" === t.position &&
                    l.setAttribute(
                      ...
                      "position: fixed !important; z-index: 1000; " +
                        i(t.corner, t.paddingx || 0, t.paddingy || 0)
                    ),
                  l.appendChild(a),
                  l
                );
              ...
              function f(t, e) {
                for (
                  var n = null,
                    r = [
                      t.repeatXpath.xpathById.prefix.slice(0, -1),
                      t.repeatXpath.xpathFromRoot.prefix.slice(0, -1),
                    ],
                    i = 0;
                  i < r.length &&
                  !(n = document.evaluate(
                ...
                var o = n.querySelector('a[href="' + e.productUrl + '"]'),
                  a = m(o);
                return [
                  g(t.repeatXpath.xpathById, a[0]),
                  g(t.repeatXpath.xpathFromRoot, a[1]),
                ];
              }
              function g(t, e) {
                if (t.prefix) {
              ...
              function m(t) {
                ...
                if (t === document.body)
                  return (
                    (e = "//" + t.tagName), (n = "/HTML[1]/BODY[1]"), [e, n]
                  );
                t.id && (e = 'id("' + t.id + '")');
                var r = 0;
                if (!t.parentNode) return [e, n];
                for (
                  var i = t.parentNode.childNodes, o = 0;
                  o < i.length;
                  o++
                ) {
                  var a = i[o];
                  if (
                    (a.id &&
                      a.id.startsWith("trustpilot-widget-trustbox-preview") &&
                      r--,
                    a === t)
                  ) {
              ...
              function h(t, e, n) {
                var r = c(t, e);
                if ("floating" === t.position)
                  document.body.appendChild(r), b(r);
                else {
                  var i = null;
                  if (t.xpath)
                    i = document.evaluate(
              ...
              function b(e) {
                "undefined" != typeof Trustpilot &&
                  t.Trustpilot.loadFromElement(e.firstChild);
              }
              function v(t) {
              ...
              function x(t) {
                try {
                  ...
                  if (t.trustboxes) {
                    for (var n = t.trustboxes, r = 0, i = 0; i < n.length; i++)
                      if (
                        ...
                        if (
                          o.repeat &&
                          o.repeatXpath &&
                          t.categoryProductsData &&
                          t.categoryProductsData.length > 1
                        )
                          for (
                            var a = 0;
                            a < t.categoryProductsData.length;
                            a++
                          ) {
                    ...
                    (e = "trustpilot-widget-trustbox"),
                      document.getElementById(e) || h(t, e, !0);
                } catch (t) {
                  console.log(
                    "Failed to parse trustBox html code snippet: " + t
                  );
                }
              }
              function y() {}
                ...
                (y.prototype = {
                  ...
                  injectTrustBoxWidget: function () {
                    ...
                    p(E) ||
                      e(
                        new Error(
                          "Invalid TrustBox settings. Widget cannot be created"
                        )
                      );
                  ...
                  createInvitation: function (t) {
                    ...
                    if (
                      (S ||
                        e(
                          new Error(
                            'Key is not set, call "register" function first'
                          )
                        ),
                      !t)
                    )
                      return void e();
                    var i =
                      "https://invitejs.trustpilot.com/api/" +
                      S +
                      "/invitation";
                    const o = t.products,
                      a = t.productSkus;
                    ...
                    n(1).load(function (n) {
                      (t.simplicity = n),
                        u(i, t, function (n, r) {
                          if (n)
                            return void e(
                              new Error("Failed to create invitation: " + n)
                            );
                          202 === r &&
                            ((t.products = o || []),
                            (t.productSkus = a || []),
                            u(i, t, function (t) {
                              if (t)
                                return void e(
                                  new Error("Failed to create invitation: " + t)
                                );
                            })),
                            e(null, t);
                        });
                  ...
                  loadTrustBoxWidget: function (t) {
                    ...
                    if (n)
                      (E = JSON.parse(n)), e(null), this.injectTrustBoxWidget();
                    else {
                      var u = this;
                      s(
                        "https://invitejs.trustpilot.com/api/" +
                        ...
                        function (t, n) {
                          if (n)
                            return void e(
                              new Error("Failed to load settings: " + n)
                            );
                          (E.businessUnitId = t.BusinessUnitId),
                            (E.weblink = t.Url),
                            (sessionStorage.trustBoxSettings =
                              JSON.stringify(E)),
                            e(null),
      ...
      function e(t) {
        ...
        (e.style.display = "none"),
          ...
          window.addEventListener(
            "message",
            function (e) {
              "https://simplicity.trustpilot.com" === e.origin &&
                t(JSON.parse(e.data.simplicity));
            },
            !1
          );
      }
